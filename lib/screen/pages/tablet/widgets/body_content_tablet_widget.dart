...
import 'package:booking_management_app/repository/fake_repository.dart';
        ...
        Row(
          ...
          children: [
            _singleItemQuickStats(
              ...
              icon:  Icons.arrow_upward, iconColor: Colors.black,
            ),
            _singleItemQuickStats(
        ...
        children: [
          InkWell(
            ...
            child: _singleRowButton(
              title: "Bookings",
              textColor:
                  _rowCurrentBtnIndex == 0 ? Colors.black : Colors.grey,
          ...
          InkWell(
            ...
            child: _singleRowButton(
              title: "Enquiries",
              textColor:
                  _rowCurrentBtnIndex == 1 ? Colors.black : Colors.grey,
          ...
          InkWell(
            ...
            child: _singleRowButton(
              title: "My Service",
              textColor:
                  _rowCurrentBtnIndex == 2 ? Colors.black : Colors.grey,
